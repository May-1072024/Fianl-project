...
const Admin = () => {
    ...
    return ( <div className='min-h-screen bg-[#212121] text-white p-8'>
        <Link to="/" className='bg-green-500 text-white font-bold px-4 py-2 rounded-full'>Go to Home Page</Link>
        ...
        <form onSubmit={addAlbumHandler} className='bg-[#181818] p-6 rounded-lg shadow-lg'>
            ...
            <div className="mb-4">
                ...
                <input type='file' className='auth-input' accept='image/*' onChange={fileChangeHandler} required />
            </div>
        ...
        <form onSubmit={addSongHandler} className='bg-[#181818] p-6 rounded-lg shadow-lg'>
            ...
            <div className="mb-4">
                ...
                <input type='text' placeholder='Singer' className='auth-input' value={singer} onChange={e => setSinger(e.target.value)} required />
            </div>
            ...
            <div className="flex justify-center md:justify-start gap-2 items-center flex-wrap">
                {
                    songs && songs.map((e, i) => (
                        <div key={i} className="bg-[#181818] p-4 rounded-lg shadow-md">
                            {
                                e.thumbnail ? <img src={e.thumbnail.url} alt="" className='mr-1 w-52 h-52' /> : <div className="flex flex-col justify-center items-center gap-2">
                                    <input type='file' onChange={fileChangeHandler} />
                                    <button onClick={()=> addThumbnailHandler(e._id)} className='bg-green-500 text-whitepx-2 py-1 rounded'>Add Thumbnail</button>
                                </div>
                            }
